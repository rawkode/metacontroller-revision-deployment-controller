...
# def objects_to_request_out(consumer_deployment_spec: CDCSpec, objects: list):
#     children = []
...
# def new_replica_set(consumer_deployment_spec: CDCSpec):
...
# def object_to_replica_set(consumer_deployment_spec: CDCSpec, object: dict):
#     annotations = {k: v for k, v in filter(
