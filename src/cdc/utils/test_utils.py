# from cdc.utils import request_in_to_objects
...
#     with open('../test/payloads/initial_request.json') as test_payload:
...
#     with open('../test/payloads/schema_exists_different_image.json') as test_payload:
#         json_object = json.load(test_payload)
#         objects = request_in_to_objects(json_object)
